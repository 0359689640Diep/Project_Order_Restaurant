...
<section class="containerMain">
    ...
    <form action="<?= $_ENV['basePath'] ?>admin/subproduct/create" method="post" class="contentMain"
        ...
        <article class="contentMain_item">
            ...
            <input name="PriceSubProduct" placeholder="Giá sản phẩm" title="Không được để trống" required type="number"
                min=0>
            <input name="QuantilySubProduct" placeholder="Số lượng sản phẩm" title="Không được để trống" required
                type="number" min=0>
