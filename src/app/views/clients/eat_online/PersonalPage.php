...
?>
<link rel="stylesheet" href="<?= $_ENV["clientsStyleOnline"] ?>PersonalPage.css">
<section class="page">
    <main>
        <?php include_once $_ENV["SideBar_Path"];  ?>

        <form action="personalpage?id=<?= $dataProfile['IdAccount'] ?>" method="post" class="containerMain" enctype="multipart/form-data">
