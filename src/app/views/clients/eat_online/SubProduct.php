<link rel="stylesheet" href="<?= $_ENV["clientsStyleOnline"] ?>Cart.css">
<form id="formCart" action="<?= $_ENV["basePath"] ?>cart?IdSubCart=<?= $_GET['IdSubCart'] ?>" method="post" class="page" id="formCart">
            ...
            <section class="listProduct">
                <table>
                    ...
                    foreach ($dataSubProduct as $valuesSubProduct) : ?>
                        <tr>
                            <td>
                                <input type='radio' name='IdSubProduct' class='rowRadio' value="<?= $valuesSubProduct['IdSubProduct'] ?>" data-quantity-id="<?= $valuesSubProduct['IdSubProduct'] ?>">
                            </td>
                            ...
                            <td>
                                <input type='number' name='quantity' min=0 value=1 max="<?= $valuesSubProduct['QuantilySubProduct'] ?>" id="<?= 'quantity' . $valuesSubProduct['IdSubProduct'] ?>">
                            </td>
                        </tr>
                    <?php endforeach ?>
                </table>
