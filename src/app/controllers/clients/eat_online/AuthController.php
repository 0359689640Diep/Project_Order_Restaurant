...
class AuthController extends BaseController
{
    ...
    public function login()
    {
        ...
        return $this->loadView("clients/eat_online/Login.php", $this->message);
    }
    ...
    public function signIn()
    {
        ...
        return $this->loadView("clients/eat_online/signIn.php", $this->message);
    }
    ...
    public function verifyAccount()
    {
        if (isset($_SESSION['VerifyAccount'])  && !empty($_SESSION['VerifyAccount'])) {
            ...
            return $this->loadView("clients/eat_online/VerificationAccount.php", $this->message);
        } else {
            http_response_code(500);
